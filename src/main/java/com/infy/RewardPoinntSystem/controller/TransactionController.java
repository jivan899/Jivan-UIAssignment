...
//    @PostMapping("/add")
//    public CustomerTransaction addTransaction(@RequestBody CustomerTransaction transaction) {
...
//    }
	...
	public List<CustomerTransactionModel> getTransactionsByCustomerId(@PathVariable Long customerId) {
